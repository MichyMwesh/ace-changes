<?php
    ...
    $config = array(
        ...
        "key"              => "dY6KRmds1TI3zInPWX8OvOtouLHJgbgOXeqyctGEvpECBPKQ", //Enter your consumer key here
        "secret"           => "LrDrAog2AsCPVG9ZFZfjKWIIth4x8SLG6yIRJN4s3a6XjJrPkFQPSC5sH1xeaqXP", //Enter your consumer secret here
        "username"         => "ACECLEANERS",
    ...
    if (isset($_POST['phone_number'])) {
        ...
        if($result['ResponseCode'] === "0"){         //STK Push request successful
            ...
            $save = $conn->query("UPDATE checked SET payment_status='Paid' WHERE id='$booking_id'");
            if ($save)
                ?>
